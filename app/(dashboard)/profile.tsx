      ...
      <ScrollView showsVerticalScrollIndicator={false} className="flex-1">
        ...
        <View className="items-center gap-4 p-6">
          <View className="relative">
            <Image
              source={{
                uri: "https://lh3.googleusercontent.com/aida-public/AB6AXuCPsfrTpweDDX2RNpZRxbn43sFHWcTf4ahNSHhB7ggOCLlkBYCwZSWDA4b8c0rrTHHOSHKUPvloePdxOUQMMChQMFgUHiSiHBt_aaQK29gKIpXd67VKvIv888FOCcytJ0v_n5J5cRV3TCFCc-_qHlI61roHnUmd344mZBxxrrumH0-d-C9cSVW49CgdH4yB3CGvf7VIWSdUey7ZN8V6b3lk32r0GqgdQWt_phabJ7LhFMel5xkCWD43VMFaVe_dx9TMrZFdqzV8ePyC"
              }}
